...
`conformance/artifacts/web/`. Then render the matrix with
...
Committed: scripts, config, `src/main.tsx`, `src/index.css`,
`src/Strings/en.json`, `public/` sample assets (fixtures reference an
image asset named `conformance_sample`), lockfile.
