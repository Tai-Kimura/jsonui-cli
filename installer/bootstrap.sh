...
#     v1.8.74  (these rules)   684 excluded / 2924 delivered  (tracked 3608)
#              — same rules; five tracked files more (tests, pruned), measured on
#              ece23d7d's tree the same way.
#     v1.8.75  (these rules)   684 excluded / 2924 delivered  (tracked 3608)
#              — same rules, same partition (no tracked file added), measured on
#              7c3df38c's tree the same way.
#     v1.8.76  (these rules)   685 excluded / 2924 delivered  (tracked 3609)
#              — same rules, one tracked test file added (pruned), measured on
#              94ec8eac's tree the same way.
#     v1.8.77  (these rules)   685 excluded / 2924 delivered  (tracked 3609)
#              — same rules, same partition (no tracked file added), measured on
#              5a6cbb45's tree the same way.
#     v1.8.78  (these rules)   686 excluded / 2924 delivered  (tracked 3610)
#              — same rules, one tracked spec file added (pruned), measured on
#              81157fc6's tree the same way.
