...
server and the L2 normalizer use the same platform-override /
platform-string-filter rules that ``jui build`` applies at build time.
"""
from __future__ import annotations

from typing import Any

from ..platform_resolver import PlatformResolver, VALID_PLATFORMS
