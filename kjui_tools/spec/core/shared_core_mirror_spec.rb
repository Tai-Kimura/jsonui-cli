...
RSpec.describe 'shared/core mirrors' do
  %w[responsive_resolver.rb layout_validator.rb layout_variant.rb attribute_validator_core.rb data_model_updater_core.rb converter_generator_core.rb string_manager_core.rb binding_validator_core.rb color_manager_core.rb type_converter_core.rb generated_orphans.rb image_accessibility.rb].each do |file|
