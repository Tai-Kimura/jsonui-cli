        ...
        def create_config_file(mode)
          ...
          if mode == 'swiftui'
            ...
            config = {
              ...
              'resources_directory' => 'Resources',  # Directory for resources (strings.json, colors.json)
          ...
          puts "Hotloader is now managed centrally — run 'jui hotload listen' from the project root."
        end
