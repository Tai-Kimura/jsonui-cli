...
module SjuiTools
  module SwiftUI
    class DataModelUpdater
      ...
      # Data models are written as <Basename>Data.swift into a single flat
      # directory (and Swift has no directory namespacing), so layout
      ...
      # abort the build. Mirrors the identical check in rjui/kjui.
