        ...
        def self.generate(output_path)
          ...
          public struct HotLoaderSetup {
              public static func configure() {
                  // Configure colors using SwiftJsonUIConfiguration
                  // You can customize these values for your app's theme
                  // SwiftJsonUIConfiguration.shared.colors.primary = .systemBlue
                  // SwiftJsonUIConfiguration.shared.colors.background = .systemBackground
                  // SwiftJsonUIConfiguration.shared.textField.cornerRadius = 8.0

                  // Configure colorProvider to use ColorManager
                  SwiftJsonUIConfiguration.shared.colorProvider = { identifier in
