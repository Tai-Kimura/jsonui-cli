        ...
        class DirectorySetup < ::SjuiTools::Core::PbxprojManager
          ...
          def create_resource_manager_files_if_needed
            ...
            if resource_manager_exists
              ...
              # ColorManager.swiftをチェック・作成
              color_manager_file = File.join(@paths.resource_manager_path, "ColorManager.swift")
              unless File.exist?(color_manager_file)
                puts "  Missing: ColorManager.swift"
                # Create empty ColorManager.swift file
                File.write(color_manager_file, "// ColorManager.swift\n// Implementation will be added separately\n")
                created_files << color_manager_file
                puts "  Created: ColorManager.swift"
              else
                puts "  Exists: ColorManager.swift"
              end
            end
